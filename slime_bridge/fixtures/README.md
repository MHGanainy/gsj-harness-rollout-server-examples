...
Both are byte-identical copies of bodies committed in the library repo
(`docs/polar/`), which is their provenance record. They are the two ends
of the trainer's world: one clean qualifying episode, one real body that
fails the gates.
